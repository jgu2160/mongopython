...
class BlogPostDAO:
    ...
    def __init__(self, database):
        ...
        self.posts.create_index([('tags',pymongo.ASCENDING),('date',pymongo.ASCENDING)])
        self.posts.create_index([('date',pymongo.ASCENDING)])
        self.posts.create_index([('permalink',pymongo.DESCENDING)])
